...
print_and_log(f"{Style.BRIGHT}{Fore.WHITE}All subtitle processing tasks completed successfully!{Style.RESET_ALL}")
print_and_log(f"{Fore.WHITE}Your video collection now has properly synchronized subtitles.{Style.RESET_ALL}\n")

print_and_log(f"{Fore.CYAN}┌{'-' * 78}┐{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}│{Style.RESET_ALL} {Style.BRIGHT}{Fore.LIGHTYELLOW_EX}Thank you for using Subservient!{Style.RESET_ALL}{' ' * 43} {Fore.CYAN}│{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}│{Style.RESET_ALL}{' ' * 78}{Fore.CYAN}│{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}│{Style.RESET_ALL} {Fore.WHITE}If this tool has been helpful, consider supporting its development:{Style.RESET_ALL}    {Fore.CYAN}│{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}│{Style.RESET_ALL} {Fore.LIGHTCYAN_EX}Buy Me a Coffee:{Style.RESET_ALL} {Style.BRIGHT}{Fore.YELLOW}https://buymeacoffee.com/nexigen{Style.RESET_ALL}{' ' * 17} {Fore.CYAN}│{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}│{Style.RESET_ALL}{' ' * 78}{Fore.CYAN}│{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}│{Style.RESET_ALL} {Fore.WHITE}Your support helps improve Subservient and provide better support.{Style.RESET_ALL}     {Fore.CYAN}│{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}│{Style.RESET_ALL} {Fore.WHITE}Thank you for being part of the Subservient community!{Style.RESET_ALL}{' ' * 21} {Fore.CYAN}│{Style.RESET_ALL}")
print_and_log(f"{Fore.CYAN}└{'-' * 78}┘{Style.RESET_ALL}")

print_and_log(f"\n{Fore.GREEN}Press any key to exit...{Style.RESET_ALL}")
input()